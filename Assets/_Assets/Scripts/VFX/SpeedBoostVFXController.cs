...
namespace Hanzo.VFX
{
    ...
    public class SpeedBoostVFXController : MonoBehaviour
    {
        ...
        [SerializeField] private bool emitWhileBoosting = true;
        
        [Tooltip("Particles to emit per interval.")]
        [SerializeField] private int speedLinesEmitCount = 3;
        
        [Tooltip("Interval between continuous emissions.")]
        [SerializeField] private float emitInterval = 0.1f;
        
        [Header("Material Effects (Optional)")]
        [Tooltip("Apply glow/emission to player materials during boost.")]
        [SerializeField] private bool applyMaterialGlow = true;
        ...
        {
            if (playerRenderers == null || propertyBlock == null) return;
            ...
            {
                // Skip VFX renderers
                if (renderer.transform.IsChildOf(vfxInstance.transform)) continue;
        ...
        {
            if (!glowActive || playerRenderers == null || propertyBlock == null) return;
        ...
        private IEnumerator DisableWhenDone()
        {
            ...
            if (vfxInstance != null) vfxInstance.SetActive(false);
        }
